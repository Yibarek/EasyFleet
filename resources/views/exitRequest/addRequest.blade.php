...
@section('title') Request Exit @endsection
      ...
      <div class="pages p-2" style="width: 120%">
        ...
        <div class="d-flex justify-content-between"style="width: 100%">
          <div class="container3 d-flex p-3 page-header">
            ...
            <label class="page_title" style="margin-top: -15px;">Request for Exit</label>
          </div>
          <div class=" " style="width: 200px;">
              @if (Auth::user()->role == "Driver")
               <input href="" type="submit"
                  class="add-new p-2" value="Send exitRequest">
              @endif
          </div>
        </div>
                    ...
                    <table class="pl-5" style="width: 100%; margin: auto;">
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input class="form-control"  type="textarea" name ="cause" id ="cause">
                                </td>
                            ...
                            <div>
                                ...
                                <td class="p-2">
                                    <div class="d-flex justify-content-bettween">
                                        <input class="mr-2 form-control" type="date" name ="start_date" id ="start_date">
                                        <input class="ml-2 form-control" type="time" name ="start_time" id ="start_time">
                                    </div>
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2">
                                    <div class="d-flex justify-content-bettween">
                                        <input class="mr-2 form-control" type="date" name ="arrival_date" id ="arrival_date">
                                        <input class="ml-2 form-control" type="time" name ="arrival_time" id ="arrival_time">
                                    </div>
                                </td>
