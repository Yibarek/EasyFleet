...
@section('title') Request Maintenance @endsection
...
<form action="/addMaintenance" method="POST">
      ...
      <div class="pages p-2" style="width: 120%">
        ...
        <div class="d-flex justify-content-between"style="width: 100%">
          <div class="container3 d-flex p-3 page-header" style="width: fit-content;">
            <div class="ri ri-car-washing-fill page-icon" style="margin-top: -15px;"></div>
            <label class="page_title" style="margin-top: -15px;">Request Maintenance</label>
          </div>
