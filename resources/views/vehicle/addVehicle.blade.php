...
<script>document.getElementById('vehicles').style.color = "#ffc451";</script>
    <form action="/addNewVehicle" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="pages p-2" style="width: 120%">
        ...
        <div class="d-flex justify-content-between"style="width: 100%">
          <div class="container3 d-flex p-3 page-header">
            ...
            <label class="page_title" style="margin-top: -15px;">Add new Vehicle</label>
          </div>
          <div class=" " style="width: 200px;">
              @if (Auth::user()->role == "Vehicle_Manager")
               <input href="" type="submit"
                  class="add-new p-2" value="Add Vehicle">
              @endif
          </div>
        </div>
                    ...
                    <table class="pl-5" style="width: 100%; margin: auto;">
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input required class="form-control"  type="text" name ="plate_no" id ="plate_no">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input required class="form-control"  type="number" name ="capacity" id ="capacity">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input class="form-control"  type="text" name ="engine_power" id ="engine_power">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input class="form-control"  type="date" name ="production_date" id ="production_date">
                                </td>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 8px;">
                                <div id="profile_photo" style="width: 150px; height: 150px;">
                                    <img src="image/vehicle/caravan.png" alt="" style="width: 100%; height: 100%;">
                                </div>
                            </td>
                        </tr>
