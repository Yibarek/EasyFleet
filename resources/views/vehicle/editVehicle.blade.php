...
@section('title') Add New Vehicle @endsection

@section('content')
<script>document.getElementById('vehicles').style.color = "#ffc451";</script>
@foreach ($vehicle as $v)
    <form action="/updateVehicle/{{$v->id}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="pages p-2" style="width: 120%">
        ...
        <div class="d-flex justify-content-between"style="width: 100%">
          <div class="container3 d-flex p-3 page-header">
            <div class="ri ri-bus-wifi-fill page-icon" style="margin-top: -15px;"></div>
            <label class="page_title" style="margin-top: -15px;">Update Vehicle</label>
          </div>
          <div class=" " style="width: 200px;">
              @if (Auth::user()->role == "Vehicle_Manager")
               <input href="" type="submit"
                  class="add-new p-2" value="Update Vehicle">
              @endif
          </div>
        </div>
                    ...
                    <table class="pl-5" style="width: 100%; margin: auto;">
                        <tr style="width: 100%; margin: auto;">
                            <div>
                                ...
                                <td class="p-2" style="width: 65%;" >
                                    <input required class="form-control"  type="text" name ="type" id ="type" value="{{$v->type}}">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" style="width: 65%;" >
                                    <input class="form-control"  type="text" name ="model" id ="model" value="{{$v->model}}">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input required class="form-control"  type="text" name ="plate_no" id ="plate_no"  value="{{$v->plate_no}}">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input class="form-control"  type="number" name ="capacity" id ="capacity" value="{{$v->capacity}}">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input required class="form-control"  type="text" name ="owner" id ="owner" value="{{$v->owner}}">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input class="form-control"  type="text" name ="engine_power" id ="engine_power" value="{{$v->engine_power}}">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input class="form-control"  type="date" name ="production_date" id ="production_date" value="{{$v->production_date}}">
                                </td>
                        ...
                        <tr style="display: none;">
                            <div>
                                ...
                                <td class="p-2">
                                    <input type="text" name ="pi" id ="pi" value="{{$v->image}}">
                                </td>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 8px;">
                                <div id="profile_photo" style="width: 150px; height: 150px;">
                                    <img src="../image/vehicle/{{$v->image}}" alt="" style="width: 100%; height: 100%;">
                                </div>
                            </td>
                        </tr>
