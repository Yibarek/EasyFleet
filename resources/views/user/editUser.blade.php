...
@foreach($user as $u)
    <form action="/updateUser/{{$u->id}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="pages p-2" style="width: 120%">
        ...
        <div class="d-flex justify-content-between"style="width: 100%">
          <div class="container3 d-flex p-3 page-header">
            <div class="ri ri-user-add-fill page-icon" style="margin-top: -15px;"></div>
            <label class="page_title" style="margin-top: -15px;">Update User</label>
          </div>
          <div class="" style="max-width: 220px; width: 200px;">
              @if (Auth::user()->role == "admin")
               <input type="submit" class="add-new p-2" value="Update User" style="max-width: 120px; width: 100px;">
              @endif
          </div>
        </div>
                    ...
                    <table class="pl-5" style="width: 100%; margin: auto;">
                        <tr style="width: 100%; margin: auto;">
                            <div>
                                ...
                                <td class="p-2" style="width: 65%;" >
                                    <input onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode == 32)" required class="form-control"  type="text" name ="username" id ="username" value="{{$u->username}}">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <select class="selectVal" name="role" id="role" onclick="eitherDriver()" style=" color: #333; width: 100%; height: 40px; border: 1px solid #e1e1e1;" @if ($u->role == 'admin') disabled @endif>
                                        <option value="Vehicle_Manager" style="color: #333;" @if ($u->role == 'Vehicle_Manager') selected @endif>Vehicle_Manager</option>
                                        <option value="Driver" @if ($u->role == 'Driver') selected @endif >Driver</option>
                                        <option value="Maintenance" @if ($u->role == 'Maintenance') selected @endif>Mechanic</option>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input required class="form-control"  type="email" name ="email" id ="email" placeholder="abc@gmail.com" value="{{$u->email}}">
                                </td>
                            ...
                            <div>
                                ...
                                <td class="p-2 d-flex" >
                                    <div class="d-flex" style="width: 55%">
                                        <img src="../image/Ethiopia1.jpg" width="35" alt=""> </img>
                                        <span style="margin-left: 10px; margin-top: 5px;">Ethiopia</span>
                                    </div>

                                    <input style="width: 60px;" disabled required class="form-control" type="tel" value="+251">
                                    <input style="width: 65%;" onkeypress="return (event.charCode >= 48 && event.charCode <= 59)" required class="form-control" type="text" min="9" maxlength="9" name ="phone_no" id ="phone_no" placeholder="909090909"  value="{{$u->phone_no}}">
                                </td>
                        ...
                        <tr style="display: none;">
                            <div>
                                ...
                                <td class="p-2">
                                    <input type="text" name ="pi" id ="pi" value="{{$u->profile_image}}">
                                </td>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 8px;">
                                <div id="profile_photo" style="width: 150px; height: 150px;">
                                    <img src="../image/profile/{{$u->profile_image}}" class="rounded-circle" style="width: 100%; height: 100%;">
                                </div>
                            </td>
                        </tr>
                        ...
                        <script>
                            ...
                            $(document).ready(function () {
                              $("#profile_image").on("change", handleFileSelect);
                              selDiv = $("#profile_photo");
                            });
                            ...
                            function handleFileSelect(e) {
                              ...
                              filesArr.forEach(function (f) {
                                ...
                                reader.onload = function (e) {
                                    document.getElementById("pi").value = f.name;
                                  var html =
                                    '<input type="image" id="image" src="' +
                                    e.target.result +
                                    "\" data-file='" +
                                    f.name +
                                    "alt='Category Image' height='100%' width='100%' class='rounded-circle'>";
                                  selDiv.html(html);
                                };
                          ...
                          <tr style="color: #fff; height: 35px;"><td colspan="2"></td><td>.</td></tr>
                          @if ($u->role == "Driver")
                          <tr class="pt-2"><td colspan="2"><hr></td></tr>
                          <tr>
                            <td style="color: #333; height: 35px; font-size: 22px; margin-top: -7px;" colspan="2" class="page-header">Driver Section</td>
                            </tr>
                            <tr class="pb-2" style="margin-top: -7px;"><td colspan="2"><hr></td></tr>

                          <tr class="licence_info p-2" style=" height: 1px;">
                            ...
                            <tr class="licence_info" style="display: none;">
                                <div style="display: none;">
                                    <td class="p-2">
                                        <label>Image1</label>
                                    </td>
                                    <td class="p-2">
                                        <input type="text" name ="pi1" id ="pi1" value="{{$u->licence}}">
                                    </td>

                                </div>
                            </tr>
                            <tr class="licence_info" style="height: 1px;">
                                <td></td>
                                <td style="padding-top: 10px; padding-bottom: 10px; margin: auto;">
                                    <div id="profile_photo1" style="width: 380px; height: 240px;">
                                        <img src="../image/driver_licence/{{$u->licence}}" alt="" style="width: 100%; height: 100%;">
                                    </div>
                                </td>
                            </tr>
                            ...
                            <script>
                                ...
                                var storedFiles1 = [];
                                $(document).ready(function () {
                                    $("#profile_image1").on("change", handleFileSelect1);
                                    selDiv1 = $("#profile_photo1");
                                });

                                function handleFileSelect1(e1) {
                                    ...
                                    storedFiles1.push(f1);

                                    var reader1 = new FileReader();
                                    reader1.onload = function (e1) {
                                        document.getElementById("pi1").value = f1.name;
                                        var html1 =
                                        '<input type="image" id="image1" src="' +
                                        e1.target.result +
                                        "\" data-file='" +
                                        f1.name +
                                ...
                                <div>
                                    ...
                                    <td style="width: 65%;" >
                                        <?php
                                            ...
                                            $day = $date -> format('d');
                                        ?>
                                        <input class="form-control"  type="date" name ="licence_expired" id ="licence_expired" value="{{$year.'-'.$month.'-'.$day}}">
                                    </td>

                                </div>
                            </tr>
                          <tr style="color: #fff; height: 45px;"><td></td><td>.</td></tr>
                          @endif
...
<script>
    function eitherDriver(){
        let selectedItem = '';
        $("select.selectVal").change(function() {
            selectedItem = $(this).children("option:selected").val();

            if(selectedI0tem == 'Driver'){
                document.getElementById("role").data-bs-toggle ="modal";
                document.getElementById("role").data-bs-target="#driver";
