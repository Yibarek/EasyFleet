      ...
      <div class="pages p-2" style="width: 120%">
        ...
        <div class="d-flex justify-content-between"style="width: 100%">
          <div class="container3 d-flex p-3 page-header">
            ...
            <label class="page_title" style="margin-top: -15px; max-width: 220px; width: 200px;">Add new User</label>
          </div>
          <div>.</div>
          <div class=" " style="width: 200px;">
              @if (Auth::user()->role == "admin")
               <input href="" type="submit"
                  class="add-new p-2" value="Add User">
              @endif
          </div>
        </div>
                    ...
                    <table class="pl-5" style="width: 100%; margin: auto;">
                        <tr style="width: 100%; margin: auto;">
                            <div>
                                ...
                                <td class="p-2" style="width: 65%;" >
                                    <input onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode == 32)" required class="form-control"  type="text" name ="username" id ="username">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <select name="role" id="role" style=" color: #333; width: 100%; height: 40px; border: 1px solid #e1e1e1;">
                                        <option value="Vehicle_Manager" style="color: #333;">Vehicle_Manager</option>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2" >
                                    <input required class="form-control"  type="email" name ="email" id ="email" placeholder="abc@gmail.com">
                                </td>
                        ...
                        <tr>
                            <div>
                                ...
                                <td class="p-2 d-flex" >
                                    ...
                                    <input style="width: 65%;" onkeypress="return (event.charCode >= 48 && event.charCode <= 59)" required class="form-control" type="text" min="9" maxlength="9" name ="phone_no" id ="phone_no" placeholder="909090909">
                                </td>
                            </div>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 8px;">
                                <div id="profile_photo" style="width: 150px; height: 150px;" class='rounded-circle'>
                                    <img src="../image/profile/default_profile.png" alt="" style="width: 100%; height: 100%;">
                                </div>
                            </td>
                        </tr>
