...
@section('title') Add Driver Info @endsection

@section('content')
<script>document.getElementById('users').style.color = "#ffc451";</script>
    <form method="POST" action="/addDriver/{{$id}}/{{$password}}" enctype="multipart/form-data">
      @csrf
      <div class="pages p-2" style="width: 120%">
        ...
        <div class="d-flex justify-content-between"style="width: 100%">
          <div class="container3 d-flex p-3 page-header">
            <div class="page-icon" style="margin-top: -15px;">
                <img src="../image/profile/driver.png" alt="" width="29" height="25">
            </div>
            <label class="page_title" style="margin-top: -15px;">Add Driver Info</label>
          </div>
          <div class="" style="max-width: 220px; width: 200px;">
              @if (Auth::user()->role == "admin")
               <input type="submit" class="add-new p-2" value="Save" style="max-width: 120px; width: 100px;">
              @endif
          </div>
        </div>
            <div style="border: 1px solid #eee;
                ...
                <div class="pl-5" style="width: 95%; margin: auto;">
                    ...
                    <table class="pl-5 licence_info1" style="width: 100%; height: 10px; margin: auto;">
                        <tr style="color: #fff; height: 20px;"><td></td><td>.</td></tr>
                        ...
                        <tr class="licence_info" style="height: 1px;">
                            ...
                            <td style="padding-left: 8px; padding-top: 10px; padding-bottom: 10px;">
                                <div id="profile_photo1" style="width: 220px; height: 120px;">
                                    <img src="../image/driver_licence/default_licence.png" alt="" style="width: 100%; height: 100%;">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="licence_info p-2" style=" height: 1px;">
                            <div>
                                ...
                                <td style="width: 65%;" >
                                    ...
                                    <input class="form-control"  type="date" name ="licence_expired" id ="licence_expired">
                                </td>

                            </div>
                        </tr>
                        <tr style="color: #fff; height: 35px;"><td></td><td>.</td></tr>
